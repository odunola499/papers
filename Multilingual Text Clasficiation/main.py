...
model = AutoModelForSequenceClassification.from_pretrained(model_url, num_labels=3).to(
    device
)
...
wandb.init(
    project="Multilingual Text Classification", entity="jenrola2292", name="first run"
)
...
for epoch in range(epochs):
    ...
    for batch in tqdm(train_loader):
        ...
        optimizer.step()
        wandb.log(
            {"epoch": epoch + 1, "training_loss": loss, "validation_accuracy": accuracy}
        )
